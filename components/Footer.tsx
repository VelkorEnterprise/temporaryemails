        ...
        <footer className="bg-[#0f172a] border-t border-white/5">
            <div className="bg-black/50 py-16 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <h3 className="font-black text-indigo-400 uppercase tracking-[0.2em] text-xs mb-8">Popular Global Searches</h3>
                    <div className="flex flex-wrap justify-center gap-3">
                        {shuffledKeywords.map((keyword, index) => (
                            <button 
                                key={index} 
                                onClick={handleActionLink}
                                className="bg-white/5 border border-white/5 text-gray-500 text-[10px] font-bold px-4 py-2 rounded-full hover:bg-indigo-600/20 hover:text-indigo-400 hover:border-indigo-500/20 transition-all uppercase tracking-widest"
                            >
                                {keyword}
                            </button>
                        ))}
